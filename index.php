...
<head>
    ...
    <!-- OpenLayers Css -->
    <link rel="stylesheet" type="text/css" href="plugins/ol/ol.css">

    <!-- OpenLayers Extensions (Github) -->
    <link rel="stylesheet" type="text/css" href="plugins/ol-ext/ol-ext.css">

    <!-- Opacity base maps switcher -->
    <link rel="stylesheet" type="text/css" href="plugins/Opacity-slider/ol3-layerswitcher.css">
...
<body class="theme-pink">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ISPRS 2020 NICE</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy;  <a href="http://www.isprs2020-nice.com/">Copyright ISPRS2020, All Rights Reserved</a>.
                </div>
            </div>
            <!-- #Footer -->
        </aside>
